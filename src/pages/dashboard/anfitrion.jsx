...
import '../../app/styles/Anfitrion.css'
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-content">
        <h2 className="dashboard-title">Tus Terrazas</h2>
        ...
        {loading ? (
          ...
          <div className="terraza-grid">
            {terrazas.length > 0 ? (
              ...
              <p className="no-terrazas-text">No has subido ninguna terraza todavía.</p>
            )}
          </div>
        )}
        ...
        {user && (
          <div className="upload-button-container">
            <button onClick={goToUpload} className="upload-button">
              Subir nueva Terraza
            </button>
          </div>
        )}
